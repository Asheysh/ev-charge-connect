    ...
    <section className="grid gap-4">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6">
        {tiles.map((t) => {
          const Icon = t.icon;
          const inner = (
            <div className="glass-panel premium-border flex flex-col items-center justify-center gap-1 rounded-2xl border p-2 text-center transition active:scale-95 hover:-translate-y-0.5 hover:shadow-panel" style={{ width: '100%', height: '120px' }}>
